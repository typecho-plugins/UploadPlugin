                    ...
                    <table class="typecho-list-table">
                        ...
                        <tbody>
                            ...
                            <tr id="plugin-<?php $deactivatedPlugins->name(); ?>">
                                ...
                                <td><a lang="<?php _e('你确认要删除 %s 插件吗?', $deactivatedPlugins->name); ?>" href="<?php $options->index('/action/upload-plugin?del=' . $deactivatedPlugins->name); ?>" class="operate-delete"><?php _e('删除'); ?></a><?php if(stristr($deactivatedPlugins->name,"master")): ?> <a lang="<?php _e('你确认要修复 %s 插件吗?', $deactivatedPlugins->name); ?>" href="<?php $options->index('/action/upload-plugin?fix=' . $deactivatedPlugins->name); ?>"><?php _e('修复'); ?></a><?php endif ?></td>
